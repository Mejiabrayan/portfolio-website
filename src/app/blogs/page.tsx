...
export default async function Blog() {
  ...
  return (
    <div className='relative min-h-screen max-w-2xl flex items-center overflow-x-hidden'>
      <div className='container px-6 min-h-full mx-auto'>
        <div className='h-full gap-5 flex flex-col justify-center items-center lg:items-center'>
          <LargeHeading size='lg' className='text-center mt-6 lg:mt-12'>
            Blog
          </LargeHeading>
          ...
          <div className='flex flex-col justify-center items-center gap-4 mt-8 lg:mt-12'>
            <LargeHeading size='sm' className='text-center'>
              Latest posts
            </LargeHeading>
            <hr className='w-full border-gray-800 mt-4 mb-6' />
